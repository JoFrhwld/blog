...
The full data set is available as a sqlite dump linked to from [the xkcd blog](https://blog.xkcd.com/2010/05/03/color-survey-results/), so this post is just about how I got set up access to it within my blog RStudio project.
